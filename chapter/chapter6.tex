...
\\\\
SOA hat seine Grundlagen nicht in der IT, sondern in Geschäftswelt. Dies wird dadurch bestätigt, das die Zielgruppe der Befragten in Kapitel \ref{chap:soa}\ \nameref{chap:soa}\ aus dem Kaufmännischen und analytischen Bereich stammen. So wird zum Beispiel der \flqq business executive\frqq\ und der \flqq business analyst\frqq\ gefragt, wie SOA zu verstehen ist. Zudem darf SOA nicht als Modell, sondern als Herangehensweise verstanden werden.
\\\\
