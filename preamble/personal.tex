...
\newcommand{\studycourse}{Softwaretechnik (Dual) - Modul Entwicklung verteilter Anwendungen}           % Studiengang
...
\newcommand{\titel}{Gemeinsamkeiten und Unterschiede von Service-orientierter Architektur (SOA) und Microservices} % Titel der Arbeit
